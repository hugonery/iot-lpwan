...
@section('content')
    ...
    <div class="page-header">
        <div class="container-fluid d-sm-flex justify-content-between">
          <h4><i class="fa fa-thermometer-half" aria-hidden="true"></i> Sensores: Cadastro</h4>
        </div>
    </div>
    <!-- end::page-header -->
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form class="needs-validation" method="post" action="{{ route('sensors.store') }}"  name="FormSensor" novalidate>
                            ...
                            <div class="form-row p-4">
                              <button class="btn btn-primary" type="submit" onclick="return checkFormSensor();">Cadastrar Sensor</button>
                            </div>
