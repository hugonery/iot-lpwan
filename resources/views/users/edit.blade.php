...
@section('content')
    ...
    <div class="page-header">
        <div class="container-fluid d-sm-flex justify-content-between">
            <h4><i class="fa fa-address-book-o" aria-hidden="true"></i> Clientes: Atualização cadastral</h4>
        </div>
    </div>
    <!-- end::page-header -->
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form class="needs-validation" method="post" action="{{ route('users.update', $user->id) }}"  name="FormUser" novalidate>
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
                            ...
                            <div class="form-row p-4">
                              <button class="btn btn-primary" onclick="return checkFormUser();">Atualizar Cadastro</button>
                            </div>
...
@section('script')
    ...
    <script language=JavaScript>
        ...
        if (FormUser.type.value==1)
            FormUser.cpfcnpj.value = ("00000000000" + FormUser.cpfcnpj.value).slice(-11);
        else if (FormUser.type.value==2) 
            FormUser.cpfcnpj.value = ("00000000000000" + FormUser.cpfcnpj.value).slice(-14);
