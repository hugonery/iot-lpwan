...
@section('content')
    ...
    <div class="page-header">
        <div class="container-fluid d-sm-flex justify-content-between">
          <h4><i class="fa fa-map-marker" aria-hidden="true"></i> Propriedades: Alteração do Cadastro</h4>
        </div>
    </div>
    <!-- end::page-header -->
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                      <form class="needs-validation" method="post" action="{{ route('places.update', $place->id) }}"  name="FormPlace" novalidate>
