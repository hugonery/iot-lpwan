...
@section('content')
    ...
    <div class="page-header">
        <div class="container-fluid d-sm-flex justify-content-between">
          <h4><i class="fa fa-wifi" aria-hidden="true"></i> Estações: Cadastro</h4>
        </div>
    </div>
    <!-- end::page-header -->
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form class="needs-validation" method="post" action="{{ route('stations.store') }}"  name="FormStation" novalidate>
                            ...
                            <div class="form-row p-4">
                              <button class="btn btn-primary" type="submit" onclick="return checkFormStation();">Cadastrar Estação</button>
                            </div>
    ...
    <script language=JavaScript>
      ...
      document.FormStation.name.focus();
